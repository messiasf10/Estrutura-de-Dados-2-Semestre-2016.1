...
public class AvlTree {  
       ...
       protected AvlNode search(AvlNode p, int el) {  
           while (p != null) {  
               ...
               /* se valor procurado < chave do no, procurar na sub-arvore esquerda deste no */  
               else if (el<p.key) p = p.left;  
               /* se valor procurado > chave do no, procurar na sub-avore direita deste no */  
               else p = p.right;  
           }  
   ...
   /* Metodo de autoria de Leonardo Zandono - 2006/2 */  
